...
for (i = 0; i < totalMonths - 1; i++) {
  profitAndLossesChanges[i] = finances[i+1][1] - finances[i][1]
  finances[i+1][3] = profitAndLossesChanges[i]
}
...
// console.log('greatestIncrease = ' + greatestIncrease)
// console.log('========')
for (i = 0; i < totalMonths; i++) {
  // console.log('i = ' + i)
  // console.log('test = ' + (greatestIncrease < profitAndLossesChanges[i+1]))
  if (greatestIncrease < profitAndLossesChanges[i+1]) {
    // profitAndLossesChanges[1] is greatest increase
    greatestIncrease = profitAndLossesChanges[i+1]
  }
  // console.log('profitAndLossesChanges[i+1] = ' + (profitAndLossesChanges[i+1]))
  // console.log('greatestIncrease = ' + greatestIncrease)
// console.log('========')
}
...
for (i = 0; i < totalMonths; i++) {
  // // console.log('i = ' + i)
  // // console.log('test = ' + (greatestDecrease > profitAndLossesChanges[i+1]))
  if (greatestDecrease > profitAndLossesChanges[i+1]) {
    // profitAndLossesChanges[1] is greatest increase
    greatestDecrease = profitAndLossesChanges[i+1]
  }
}
// // console.log('profitAndLossesChanges[i+1] = ' + (profitAndLossesChanges[i+1]))
// // console.log('========')
